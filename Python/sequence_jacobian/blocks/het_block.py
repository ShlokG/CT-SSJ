...
class HetBlock(Block):
    ...
    '''Get all intermediate matrices'''
    def _jacobian_intermed(self, ss, inputs, outputs, T, h=1E-4, twosided=False):
        ss = self.extract_ss_dict(ss)
        outputs = self.M_outputs.inv @ outputs
        ...
        return J, F, curlyPs, curlyYs, curlyDs
